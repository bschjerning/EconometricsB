...
def summary(models, options=None, column_titles=None, report_stats="se", print_regressors=None):
    """
    ...
    for regressor in all_regressors:
        if print_regressors is not None and regressor not in print_regressors:
            continue
    ...
    if print_regressors is not None:
        print(f"Only showing subset of regressors.")
    print("\n")
